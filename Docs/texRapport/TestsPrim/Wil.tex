\subsection{Test de Wilson}
	...
	En effet, ce théorème était connu à partir du XVII\up{e} siècle en Europe. En 1770, \textit{John Wilson} redécouvre une conjecture de ce théorème et la publie. Ensuite, les mathématiciens \textit{Lagrange}, \textit{Euler} et \textit{Gauss} le démontrent chacun à leur tour. 
