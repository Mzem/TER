...
// Génération clés : trois variantes : génération avec test de primalité déterministe et probabiliste et optimal
...
void generationClesRSA_opt (double [6][1025], mpz_t n, mpz_t e, mpz_t d);
