...
\newpage\clearpage\pagenumbering{arabic}
	...
	\section{Cryptosystèmes}
		...
		Dans cette partie, on va détailler ces cryptosystèmes et exhiber rôle important des tests de primalité.
		
		\subsection{RSA}
		Décrit en 1977 par Ronald Rivest, Adi Shamir et Leonard Adleman, RSA est un cryptosystème basé sur le problème de factorisation, qui utilise une paire de clés (publique, privée) qui permettent de chiffrer et de déchiffrer un message. Le fonctionnement de RSA peut être décrit en 3 phases :
			...
			\subsubsection*{Nombres premiers et tests de primalité}
			La première étape dans RSA est la génération de 2 nombres premiers dont la taille en bits est la moitié de celle du module RSA.
		\subsection{ElGamal}
